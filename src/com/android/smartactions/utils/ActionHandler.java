...
package com.android.smartactions.utils;
...
import com.android.smartactions.R;
...
public class ActionHandler {
    ...
    public static final String SMART_ACTIONS = "com.android.smartactions";
    ...
    static {
        ...
        sDisabledActions.add(SYSTEMUI_TASK_EDITING_SMARTBAR);
    }

    static enum SystemAction {
        NoAction(SYSTEMUI_TASK_NO_ACTION, R.string.label_action_no_action, R.drawable.ic_sysbar_no_action, R.drawable.ic_sysbar_no_action_dark),
        SettingsPanel(SYSTEMUI_TASK_SETTINGS_PANEL, R.string.label_action_settings_panel, R.drawable.ic_sysbar_settings_panel, R.drawable.ic_sysbar_settings_panel_dark),
        NotificationPanel(SYSTEMUI_TASK_NOTIFICATION_PANEL, R.string.label_action_notification_panel, R.drawable.ic_sysbar_notification_panel, R.drawable.ic_sysbar_notification_panel_dark),
        Screenshot(SYSTEMUI_TASK_SCREENSHOT, R.string.label_action_screenshot, R.drawable.ic_sysbar_screenshot, R.drawable.ic_sysbar_screenshot_dark),
        RegionScreenshot(SYSTEMUI_TASK_REGION_SCREENSHOT, R.string.label_action_region_screenshot, R.drawable.ic_sysbar_region_screenshot, R.drawable.ic_sysbar_region_screenshot_dark),
        Screenrecord(SYSTEMUI_TASK_SCREENRECORD, R.string.label_action_screenrecord, R.drawable.ic_sysbar_record_screen, R.drawable.ic_sysbar_record_screen_dark),
        ExpandedDesktop(SYSTEMUI_TASK_EXPANDED_DESKTOP, R.string.label_action_expanded_desktop, R.drawable.ic_sysbar_expanded_desktop, R.drawable.ic_sysbar_expanded_desktop_dark),
        ScreenOff(SYSTEMUI_TASK_SCREENOFF, R.string.label_action_screen_off, R.drawable.ic_sysbar_screen_off, R.drawable.ic_sysbar_screen_off_dark),
        KillApp(SYSTEMUI_TASK_KILL_PROCESS, R.string.label_action_force_close_app, R.drawable.ic_sysbar_killtask, R.drawable.ic_sysbar_killtask_dark),
        Assistant(SYSTEMUI_TASK_ASSIST, R.string.label_action_search_assistant, R.drawable.ic_sysbar_assist, R.drawable.ic_sysbar_assist_dark),
        GoogleNowOnTap(SYSTEMUI_TASK_GOOGLE_NOW_ON_TAP, R.string.label_action_google_now_on_tap, R.drawable.ic_sysbar_google_now_on_tap, R.drawable.ic_sysbar_google_now_on_tap_dark),
        VoiceSearch(SYSTEMUI_TASK_VOICE_SEARCH, R.string.label_action_voice_search, R.drawable.ic_sysbar_search, R.drawable.ic_sysbar_search_dark),
        InAppSearch(SYSTEMUI_TASK_APP_SEARCH, R.string.label_action_in_app_search, R.drawable.ic_sysbar_in_app_search, R.drawable.ic_sysbar_in_app_search_dark),
        Flashlight(SYSTEMUI_TASK_TORCH, R.string.label_action_flashlight, R.drawable.ic_sysbar_torch, R.drawable.ic_sysbar_torch_dark),
        Bluetooth(SYSTEMUI_TASK_BT, R.string.label_action_bluetooth, R.drawable.ic_sysbar_bt, R.drawable.ic_sysbar_bt_dark),
        WiFi(SYSTEMUI_TASK_WIFI, R.string.label_action_wifi, R.drawable.ic_sysbar_wifi, R.drawable.ic_sysbar_wifi_dark),
        Hotspot(SYSTEMUI_TASK_WIFIAP, R.string.label_action_hotspot, R.drawable.ic_sysbar_hotspot, R.drawable.ic_sysbar_hotspot_dark),
        LastApp(SYSTEMUI_TASK_LAST_APP, R.string.label_action_last_app, R.drawable.ic_sysbar_lastapp, R.drawable.ic_sysbar_lastapp_dark),
        Overview(SYSTEMUI_TASK_RECENTS, R.string.label_action_overview, R.drawable.ic_smartbar_recent, R.drawable.ic_smartbar_recent_dark),
        PowerMenu(SYSTEMUI_TASK_POWER_MENU, R.string.label_action_power_menu, R.drawable.ic_sysbar_power_menu, R.drawable.ic_sysbar_power_menu_dark),
        Menu(SYSTEMUI_TASK_MENU, R.string.label_action_menu, R.drawable.ic_smartbar_menu, R.drawable.ic_smartbar_menu_dark),
        Back(SYSTEMUI_TASK_BACK, R.string.label_action_back, R.drawable.ic_smartbar_back, R.drawable.ic_smartbar_back_dark),
        Home(SYSTEMUI_TASK_HOME, R.string.label_action_home, R.drawable.ic_smartbar_home, R.drawable.ic_smartbar_home_dark),
        Ime(SYSTEMUI_TASK_IME_SWITCHER, R.string.label_action_ime_switcher, R.drawable.ic_ime_switcher_smartbar, R.drawable.ic_ime_switcher_smartbar_dark),
        StopScreenPinning(SYSTEMUI_TASK_STOP_SCREENPINNING, R.string.label_action_stop_screenpinning, R.drawable.ic_smartbar_screen_pinning_off, R.drawable.ic_smartbar_screen_pinning_off_dark),
        ImeArrowDown(SYSTEMUI_TASK_IME_NAVIGATION_DOWN, R.string.label_action_ime_down, R.drawable.ic_sysbar_ime_down, R.drawable.ic_sysbar_ime_down_dark),
        ImeArrowLeft(SYSTEMUI_TASK_IME_NAVIGATION_LEFT, R.string.label_action_ime_left, R.drawable.ic_sysbar_ime_left, R.drawable.ic_sysbar_ime_left_dark),
        ImeArrowRight(SYSTEMUI_TASK_IME_NAVIGATION_RIGHT, R.string.label_action_ime_right, R.drawable.ic_sysbar_ime_right, R.drawable.ic_sysbar_ime_right_dark),
        ImeArrowUp(SYSTEMUI_TASK_IME_NAVIGATION_UP, R.string.label_action_ime_up, R.drawable.ic_sysbar_ime_up, R.drawable.ic_sysbar_ime_up_dark),
        ClearNotifications(SYSTEMUI_TASK_CLEAR_NOTIFICATIONS, R.string.label_action_clear_notifications, R.drawable.ic_sysbar_clear_notifications, R.drawable.ic_sysbar_clear_notifications_dark),
        VolumePanel(SYSTEMUI_TASK_VOLUME_PANEL, R.string.label_action_volume_panel, R.drawable.ic_sysbar_volume_panel, R.drawable.ic_sysbar_volume_panel_dark),
        EditingSmartbar(SYSTEMUI_TASK_EDITING_SMARTBAR, R.string.label_action_editing_smartbar, R.drawable.ic_sysbar_editing_smartbar, R.drawable.ic_sysbar_editing_smartbar_dark),
        SplitScreen(SYSTEMUI_TASK_SPLIT_SCREEN, R.string.label_action_split_screen, R.drawable.ic_smartbar_docked, R.drawable.ic_smartbar_docked_dark),
        OneHandedModeLeft(SYSTEMUI_TASK_ONE_HANDED_MODE_LEFT, R.string.label_action_one_handed_mode_left, R.drawable.ic_sysbar_one_handed_mode_left, R.drawable.ic_sysbar_one_handed_mode_left_dark),
        OneHandedModeRight(SYSTEMUI_TASK_ONE_HANDED_MODE_RIGHT, R.string.label_action_one_handed_mode_right, R.drawable.ic_sysbar_one_handed_mode_right, R.drawable.ic_sysbar_one_handed_mode_right_dark),
        MediaArrowLeft(SYSTEMUI_TASK_MEDIA_PREVIOUS, R.string.label_action_media_left, R.drawable.ic_skip_previous, R.drawable.ic_skip_previous_dark),
        MediaArrowRight(SYSTEMUI_TASK_MEDIA_NEXT, R.string.label_action_media_right, R.drawable.ic_skip_next, R.drawable.ic_skip_next_dark),
        AssistantSoundSearch(SYSTEMUI_TASK_ASSISTANT_SOUND_SEARCH, R.string.label_action_assistant_sound_search, R.drawable.ic_assistant_sound_search, R.drawable.ic_assistant_sound_search_dark),
        PlayPause(SYSTEMUI_TASK_MEDIA_PLAY_PAUSE, R.string.label_action_play_pause, R.drawable.ic_sysbar_play_pause, R.drawable.ic_sysbar_play_pause_dark),
        RingVibeSilent(SYSTEMUI_TASK_SOUNDMODE_VIB_SILENT, R.string.label_action_ring_vibe_silent, R.drawable.ic_sysbar_ring_vibe_silent, R.drawable.ic_sysbar_ring_vibe_silent_dark),
        Camera(SYSTEMUI_TASK_CAMERA, R.string.label_action_camera, R.drawable.ic_sysbar_camera, R.drawable.ic_sysbar_camera_dark);
        ...
        private SystemAction(String action, int labelRes,  int iconRes, int darkIconRes) {
            mAction = action;
            mLabelRes = labelRes;
            mIconRes = iconRes;
            mDarkIconRes = darkIconRes;
        }
    ...
    public static class ActionIconResources {
        ...
        public ActionIconResources(Context ctx) {
            ...
            for (int i = 0; i < systemActions.length; i++) {
                ...
                mDrawables[i] = res.getDrawable(systemActions[i].mIconRes, ctx.getTheme());
                mDarkDrawables[i] = res.getDrawable(systemActions[i].mDarkIconRes, ctx.getTheme());
            }
        }

        public void updateResources(Context ctx) {
            Resources res = ctx.getResources();
...
//                || action.equals(ActionConstants.ACTION_MENU_BIG)
    ...
    private static ActivityOptions getAnimation(Context context) {
        return ActivityOptions.makeCustomAnimation(context,
                com.android.internal.R.anim.smartaction_app_in,
                com.android.internal.R.anim.smartaction_app_out);
    }
...
/*        ContentResolver cr = context.getContentResolver();
    ...
    private static void launchScreenRecord(Context context) {
        new ScreenRecordHelper(context).launchRecordPrompt();
    }
    ...
    public static void killProcess(Context context) {
        ...
        // get current launcher packackage
        final ArrayList<ResolveInfo> homeActivities = new ArrayList<>();
        ComponentName homeComponent = pm.getHomeActivities(homeActivities);
        String homePackage = homeComponent.getPackageName();

        // return if for some reason these are null
        StackInfo focusedStack = null;
        try {
            focusedStack = am.getFocusedStackInfo();
        ...
        // if top activitiy is launcher, SystemUI, or live wallpaper, return
        final String packageName = focusedStack.topActivity.getPackageName();
        if (packageName.equals(homePackage)
                || packageName.equals(SYSTEMUI)
                || isPackageLiveWalls(context, packageName)) {
            return;
        }
        ...
        try {
            final ParceledListSlice<ActivityManager.RecentTaskInfo> recentTasks = am
                    .getRecentTasks(ActivityTaskManager.getMaxRecentTasksStatic(),
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (recentInfo.baseIntent.getComponent().getPackageName().equals(packageName)) {
        ...
        // get killed app label and fire off a toast
        String pkgName;
        try {
            pkgName = (String) pm.getApplicationLabel(
        ...
        String toastMsg = context.getString(com.android.internal.R.string.app_killed_message,
                pkgName);
